  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-500">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-16 left-12 transform rotate-12 animate-float animation-delay-1000">
          <div className="w-12 h-12 bg-blue-500/20 dark:bg-blue-400/30 rounded-lg flex items-center justify-center backdrop-blur-sm shadow-lg shadow-blue-500/30">
        ...
        <div className="absolute top-32 right-20 transform -rotate-45 animate-float animation-delay-2000">
          <div className="w-16 h-16 bg-orange-500/20 dark:bg-orange-400/30 rounded-full flex items-center justify-center backdrop-blur-sm shadow-lg shadow-orange-500/30">
            <Code className="w-8 h-8 text-orange-600 dark:text-orange-400" />
          </div>
        </div>

        <div className="absolute top-1/4 left-16 transform rotate-45 animate-float animation-delay-3000">
          <div className="w-10 h-10 bg-red-500/20 dark:bg-red-400/30 rounded-lg flex items-center justify-center backdrop-blur-sm shadow-lg shadow-red-500/30">
            <Database className="w-5 h-5 text-red-600 dark:text-red-400" />
          </div>
        </div>

        <div className="absolute top-1/3 right-12 transform -rotate-12 animate-float animation-delay-1500">
          <div className="w-14 h-14 bg-green-500/20 dark:bg-green-400/30 rounded-full flex items-center justify-center backdrop-blur-sm shadow-lg shadow-green-500/30">
            <Smartphone className="w-7 h-7 text-green-600 dark:text-green-400" />
          </div>
        </div>

        <div className="absolute bottom-1/3 left-20 transform rotate-30 animate-float animation-delay-2500">
          <div className="w-12 h-12 bg-purple-500/20 dark:bg-purple-400/30 rounded-lg flex items-center justify-center backdrop-blur-sm shadow-lg shadow-purple-500/30">
            <Zap className="w-6 h-6 text-purple-600 dark:text-purple-400" />
          </div>
        </div>

        <div className="absolute bottom-1/4 right-24 transform -rotate-30 animate-float animation-delay-4000">
          <div className="w-11 h-11 bg-gray-500/20 dark:bg-gray-400/30 rounded-full flex items-center justify-center backdrop-blur-sm shadow-lg shadow-gray-500/30">
            <Apple className="w-5 h-5 text-gray-700 dark:text-gray-300" />
          </div>
        </div>

        <div className="absolute bottom-20 left-1/4 transform rotate-15 animate-float animation-delay-3500">
          <div className="w-13 h-13 bg-indigo-500/20 dark:bg-indigo-400/30 rounded-lg flex items-center justify-center backdrop-blur-sm shadow-lg shadow-indigo-500/30">
        ...
        <div className="absolute top-2/3 right-32 transform rotate-60 animate-float animation-delay-1800">
          <div className="w-9 h-9 bg-cyan-500/20 dark:bg-cyan-400/30 rounded-full flex items-center justify-center backdrop-blur-sm shadow-lg shadow-cyan-500/30">
